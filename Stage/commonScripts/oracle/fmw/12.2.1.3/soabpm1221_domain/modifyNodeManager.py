...
def main():
  try:
    ...
    print (lineSeperator)    
    createNodeManagerPropertiesFile(javaHome, nodeMgr1Home, nodeMgr1Type, nodeMgr1ListenAddress, nodeMgr1ListenPort)
    ...
    if server2Enabled == 'true':
      ...
      print (lineSeperator)
      createNodeManagerPropertiesFile(javaHome, nodeMgr2Home, nodeMgr2Type, nodeMgr2ListenAddress, nodeMgr2ListenPort)
