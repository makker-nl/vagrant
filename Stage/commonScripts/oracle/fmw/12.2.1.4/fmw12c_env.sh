...
export FMW_VER=12.2.1.4
export FMW_ZIP_HOME=$INSTALL_BIN_HOME/Oracle/FMW/$FMW_VER
export FMW_EXTRACT_HOME=$EXTRACT_HOME/Oracle/FMW/$FMW_VER
...
#
#RCU
export RCU_ALL_COMPONENT_LIST=STB,WLS,SOAINFRA,UCSUMS,CONTENT,MDS,CAPTURE,OPSS,CONTENTSEARCH,IAU,IAU_APPEND,IAU_VIEWER,WEBCENTER,PORTLET,ACTIVITIES,DISCUSSIONS,ESS,MFT
export RCU_SOA_COMPONENT_LIST=UCSUMS,MDS,WLS,STB,OPSS,IAU,IAU_APPEND,IAU_VIEWER,SOAINFRA
export RCU_MFT_COMPONENT_LIST=STB,OPSS,ESS,UCSUMS,IAU,IAU_APPEND,IAU_VIEWER,MDS,WLS,MFT
export RCU_COMPONENT_LIST=$RCU_ALL_COMPONENT_LIST
