#!/bin/bash
#
# Download the Linux X64 Compressed Archive from https://www.oracle.com/java/technologies/downloads/#java25
#
SCRIPTPATH=$(dirname $0)
#
. $SCRIPTPATH/../../../install_env.sh
#
JAVA_HOME=$ORACLE_BASE/product/jdk25
JAVA_INSTALL_HOME=$INSTALL_HOME/Oracle/Java
JAVA_INSTALL_TMP=$INSTALL_TMP_DIR/jdk
JDK_BASE_NAME=jdk-25*
