...
#
SQLDEV_STAGE_HOME=/media/sf_Stage/DBInstallation
SQLDEV_ZIP_HOME=$SQLDEV_STAGE_HOME/Zipped/SQLDeveloper
SQLDEV_INSTALL_HOME=$SQLDEV_STAGE_HOME/Extracted/SQLDeveloper
